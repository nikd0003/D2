...
>>> Post.objects.create(author=Author.objects.get(authorUser=User.objects.get(username='First')), categoryType='NW', title='tratata title', text='tratata text')
>>> Post.objects.create(author=Author.objects.get(authorUser=User.objects.get(username='First')), categoryType='AR', title='tratatushki title', text='tratatushki text')
>>> Post.objects.create(author=Author.objects.get(authorUser=User.objects.get(username='Second')), categoryType='NW', title='tratata2 title', text='tratata2 text')
>>> Post.objects.create(author=Author.objects.get(authorUser=User.objects.get(username='Second')), categoryType='AR', title='tratatushki2 title', text='tratatushki2 text')
